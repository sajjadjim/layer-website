  ...
  return (
    <div>
      ...
      <div className='grid items-center justify-center text-center mt-10'>
        ...
        <p className='my-3 opacity-60'>Our platform connects you with verified, experienced Lawyers across various specialties — all at your convenience. Whether it's a routine checkup or urgent consultation, book appointments in minutes and receive quality care you can trust.</p>
      </div>
      ...
      {visibleCount < data.length && (
        <div className="flex justify-center my-6">
          <button onClick={handleShowMore} className="btn px-6 py-2 bg-green-800 text-white rounded-full hover:bg-blue-700 transition">
            Show All Layer
          </button>
        </div>
      )}
